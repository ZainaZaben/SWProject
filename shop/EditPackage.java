...
public class EditPackage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel6.setBackground(new java.awt.Color(245, 124, 54));
        ...
        jButton_Update.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 14)); // NOI18N
        ...
        jTextField1.setText("Enter Package ID");
    ...
    private void jButton_UpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton_UpdateMouseClicked
        // TODO add your handling code here:
        String query = "UPDATE `order` SET `senderName`='"+ jTextField_SenderName.getText() +"',`receiverName`='"+ jTextField_ReceiverName.getText() +"',`type`='"+ jTextField_Type.getText() +"',`phone`='"+ jTextField_ReceiverPhone.getText() +"',`price`='"+ jTextField_Price +"',`address`='"+ jTextField_ReceiverAddress.getText() +"' WHERE `id`="+ jTextField1.getText();
        PackageList PL = new PackageList();
        PL.excuteSQlQuery(query, "Updated");
    ...
    public static javax.swing.JTextField jTextField_ReceiverAddress;
    public static javax.swing.JTextField jTextField_ReceiverName;
    public static javax.swing.JTextField jTextField_ReceiverPhone;
    public static javax.swing.JTextField jTextField_SenderName;
    public static javax.swing.JTextField jTextField_Type;
